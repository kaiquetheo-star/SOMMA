...
const ALIAS_SEEDS: readonly AliasSeed[] = [
  ...
  {
    baseSlug: 'bayesian_curl',
    slug: 'bodyweight_drag_curl_long_head',
    name: 'Bodyweight Drag Curl Long Head',
    movement_pattern: 'isolation',
    primary_muscle: 'biceps',
    equipment_required: ['bodyweight', 'dumbbells', 'full_gym'],
  },
  {
    baseSlug: 'bayesian_curl',
    slug: 'dumbbell_incline_curl_long_head',
    name: 'Dumbbell Incline Curl Long Head',
    movement_pattern: 'isolation',
    primary_muscle: 'biceps',
    equipment_required: ['dumbbells', 'full_gym', 'bodyweight'],
  },
  {
    baseSlug: 'bayesian_curl',
    slug: 'cable_bayesian_drag_curl_long_head',
    name: 'Cable Bayesian Drag Curl Long Head',
    movement_pattern: 'isolation',
    primary_muscle: 'biceps',
    equipment_required: ['full_gym', 'dumbbells'],
  },
  ...
  {
    baseSlug: 'spider_curl',
    slug: 'bodyweight_concentration_curl_short_head',
    name: 'Bodyweight Concentration Curl Short Head',
    movement_pattern: 'isolation',
    primary_muscle: 'biceps',
    equipment_required: ['bodyweight', 'dumbbells', 'full_gym'],
  },
  {
    baseSlug: 'spider_curl',
    slug: 'dumbbell_preacher_curl_short_head',
    name: 'Dumbbell Preacher Curl Short Head',
    movement_pattern: 'isolation',
    primary_muscle: 'biceps',
    equipment_required: ['dumbbells', 'full_gym', 'bodyweight'],
  },
  {
    baseSlug: 'preacher_curl_machine',
    slug: 'spider_concentration_curl_short_head',
    name: 'Spider Concentration Curl Short Head',
    movement_pattern: 'isolation',
    primary_muscle: 'biceps',
    equipment_required: ['bodyweight', 'dumbbells', 'full_gym'],
  },
  ...
  {
    baseSlug: 'push_up',
    slug: 'ab_wheel_rollout_anti_extension',
  ...
  {
    baseSlug: 'push_up',
    slug: 'dead_bug_hollow_hold_plank',
    name: 'Dead Bug Hollow Hold Plank',
    movement_pattern: 'isolation',
    primary_muscle: 'core',
    equipment_required: ['bodyweight', 'dumbbells', 'full_gym'],
  },
  {
    baseSlug: 'push_up',
    slug: 'bodyweight_crunch_plank_stabilization',
    name: 'Bodyweight Crunch Plank Stabilization',
    movement_pattern: 'isolation',
    primary_muscle: 'core',
    equipment_required: ['bodyweight', 'dumbbells', 'full_gym'],
  },
